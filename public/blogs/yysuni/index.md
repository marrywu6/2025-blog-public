...
![img](https://www.yysuni.com/blogs/readme/730266f17fab9717.png)

无需配置，直接点部署

![img](https://www.yysuni.com/blogs/readme/95dee9a69154d0d0.png)
...
![img](https://www.yysuni.com/blogs/readme/0abb3b592cbedad6.png)

进入开发者页面，点击 **New Github App**

*GitHub App name* 和 *Homepage URL* , 输入什么都不影响。Webhook 也关闭，不需要。

![img](https://www.yysuni.com/blogs/readme/71dcd9cf8ec967c0.png)

只需要注意设置一个仓库 write 权限，其它不用。

![img](https://www.yysuni.com/blogs/readme/2be290016e56cd34.png)

点击创建，谁能安装这个仓库这个选择无所谓。直接创建。

![img](https://www.yysuni.com/blogs/readme/aa002e6805ab2d65.png)
...
![img](https://www.yysuni.com/blogs/readme/c122b1585bb7a46a.png)

这里一定要只**授权当前项目**。

![img](https://www.yysuni.com/blogs/readme/2cf1cee3b04326f1.png)
...
![img](https://www.yysuni.com/blogs/readme/c5a049d737848abf.png)

设置完成后，需要手动再部署一次，让环境变量生效。

- 可以直接 push 一次仓库代码会触发部署
- 也可以手动选择创建一次部署 ![img](https://www.yysuni.com/blogs/readme/59a802ed8d1c3a13.png)
...
![img](https://www.yysuni.com/blogs/readme/cddb4710e08a5069.png)
...
![img](https://www.yysuni.com/blogs/readme/f70ff3fe3a77f193.png)

### 8.2 配置首页内容

首页的内容现在只能前端配置一部分，所以代码更改在 `src/app/(home)` 目录，这个目录代表首页所有文件。首页的具体文件为 `src/app/(home)/page.tsx`

![img](https://www.yysuni.com/blogs/readme/011679cd9bf73602.png)

这里可以看到有很多 `Card` 文件，需要改那个首页 Card 内容就可以点入那个具体文件修改。

比如中间的内容，为 `HiCard`，点击 `hi-card.tsx` 文件，即可更改其内容。

![img](https://www.yysuni.com/blogs/readme/20b0791d012163ee.png)

#### 特殊的导航 Card

因为这个 Card 是全局都在的，所以放在了 `src/components` 目录

![img](https://www.yysuni.com/blogs/readme/9780c38f886322fd.png)

### 8.3 移除 blog 列表的更多按钮

`src/app/blog/page.tsx` 文件，下图位置，删除这部分代码。

![img](https://www.yysuni.com/blogs/readme/a190410a273b2bea.png)
